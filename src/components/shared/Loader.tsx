...
// [SPINNER] Original yellow/orange square spinner.
// Only used for full-page route transitions (loading.tsx).
// For section-level loading, use Skeletons.tsx components instead.
const Loader = () => {
  return (
