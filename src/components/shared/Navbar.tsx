...
export function Navbar() {
  ...
  useEffect(() => {
    // [OPTIMIZATION] Use passive scroll listener to avoid blocking scrolling.
  ...
  // [OPTIMIZATION] Memoize routes array to prevent recreation on every render
  ...
  return (
    ...
    >
      <div
        className={cn(
          "transition-all duration-500 ease-in-out flex items-center justify-between page-container",
          scrolled
            ? "bg-white/80 dark:bg-gray-950/50 backdrop-blur-xl border border-white/20 dark:border-gray-800/50 shadow-lg px-6 py-3 rounded-[5rem]"
            : "bg-transparent px-2 py-2 rounded-none border-transparent"
        )}
      >
        {/* [OPTIMIZATION] Logo image: explicit dimensions, no priority needed
            since it's small and renders quickly */}
        <div className="flex">
        ...
        <div className="flex lg:hidden items-center gap-2">
          ...
          <Sheet>
            ...
            <SheetContent
              side="right"
              className="w-[300px] p-0 border-l dark:border-white/10 z-[99999] overflow-hidden"
            >
                        ...
                        <SheetClose asChild key={route.href}>
                          <Link
                            ...
                            className={cn(
                              ...
                              isActive
                                ? "text-amber-600 dark:text-yellow-400 translate-x-2"
