...
const AllProjects = ({ projects }: { projects: TProjects[] }) => {
  ...
  return (
    <div>
      ...
      <section className="min-h-[500px] py-20 bg-white dark:bg-[#0a0219] w-full transition-colors duration-300">
        <div className="page-container px-4">
          ...
          {allFilteredProjects.length === 0 ? (
            ...
            >
              ...
              <h2 className="text-2xl md:text-3xl font-bold text-gray-400 dark:text-gray-600">No {activeTab} projects found</h2>
              <p className="text-gray-500 mt-2 max-w-sm mx-auto">
                I haven&apos;t added any projects to this category yet. Check back soon for updates!
              </p>
            </motion.div>
          ) : (
            <>
