...
const contactInfo = [
  { icon: <Mail />, label: "Email Me", val: "subirdas1045@gmail.com" },
  {
    icon: <House />,
    label: "Address",
    val: "Akbarshah, Pahartali, Chattogram",
  },
...
const ContactSection = ({ className }: { className?: string }) => {
  ...
  return (
    <div className="bg-white dark:bg-[#0a0219]">
        ...
        <section className="relative flex flex-col items-center justify-center min-h-[450px] bg-gradient-to-br from-[#F9FAFB] via-[#fff8e1] to-[#faffdd] dark:from-[#0a0219] dark:via-[#120825] dark:to-[#1b0c2d] text-gray-900 dark:text-white overflow-hidden">
          ...
          >
            ...
            <p className="mt-2 text-lg md:text-xl text-gray-700 dark:text-gray-300 max-w-2xl mx-auto font-medium">
              Let&apos;s build something extraordinary together. I&apos;m always
      ...
      {/* --- Main Card Section --- */}
      <section
        className={`transition-colors duration-300 ${className ?? "py-10 md:py-16"}`}
      >
                ...
                >
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    <div className="space-y-1">
                      <Input
                        ...
                        className={`bg-white/50 dark:bg-gray-800/50 border-gray-200 dark:border-white/10 h-14 rounded-2xl focus-visible:ring-amber-500 transition-all shadow-sm ${errors.name ? "border-red-500 ring-1 ring-red-500" : ""}`}
                      />
                      {errors.name && (
                        <p className="text-red-500 text-[10px] font-bold px-2 uppercase">
                          {errors.name.message}
                        </p>
                      )}
                    </div>
                  ...
                  <div className="space-y-1">
                    <Input
                      ...
                      className={`bg-white/50 dark:bg-gray-800/50 border-gray-200 dark:border-white/10 h-14 rounded-2xl focus-visible:ring-amber-500 transition-all shadow-sm ${errors.email ? "border-red-500 ring-1 ring-red-500" : ""}`}
                    />
                    {errors.email && (
                      <p className="text-red-500 text-[10px] font-bold px-2 uppercase">
                  ...
                  <div className="space-y-1">
                    <Input
                      ...
                      placeholder="Subject"
                      className={`bg-white/50 dark:bg-gray-800/50 border-gray-200 dark:border-white/10 h-14 rounded-2xl focus-visible:ring-amber-500 transition-all shadow-sm ${errors.subject ? "border-red-500 ring-1 ring-red-500" : ""}`}
                    />
                    {errors.subject && (
                      <p className="text-red-500 text-[10px] font-bold px-2 uppercase">
                  ...
                  <div className="space-y-1">
                    <Textarea
                      ...
                      className={`bg-white/50 dark:bg-gray-800/50 border-gray-200 dark:border-white/10 min-h-[150px] rounded-2xl focus-visible:ring-amber-500 transition-all shadow-sm ${errors.message ? "border-red-500 ring-1 ring-red-500" : ""}`}
                    />
                    {errors.message && (
                      <p className="text-red-500 text-[10px] font-bold px-2 uppercase">
                  ...
                  >
                    {isSubmitting ? (
                      <span className="flex items-center justify-center gap-2">
                        {/* [SPINNER] Original yellow/orange square spinner inside button */}
                        <span className="relative inline-block w-5 h-5 shrink-0">
                          <span className="absolute inset-0 bg-yellow-400 opacity-75 animate-[spin_1.5s_linear_infinite] transform rotate-45 rounded-sm"></span>
                          <span className="absolute inset-0 bg-orange-500 opacity-75 animate-[spin_1.5s_linear_infinite] rounded-sm"></span>
                        </span>
                        Sending...
                      </span>
                    ) : "Send Message"}
