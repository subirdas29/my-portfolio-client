...
// [OPTIMIZATION] Extract static data outside component to prevent recreation on every render.
// This array never changes, so defining it outside avoids unnecessary allocations.
const socialLinks = [
  {
      ...
      <div className="page-container">
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          ...
          >
            ...
            {/* [OPTIMIZATION] Image: lazy-loaded by default (below the fold).
                Removed 'priority' since this is not above-the-fold content.
            ...
            {/* [OPTIMIZATION] Floating Tech Badges - transform-only animations */}
            <motion.div
              animate={{ y: [0, -10, 0] }}
            ...
            >
              ...
              <div className="pr-1 md:pr-2">
                ...
                <p className="text-[10px] md:text-xs font-black text-slate-900 dark:text-white">
                  AI Agent
                </p>
              </div>
            </motion.div>
            ...
            >
              ...
              <p className="text-[10px] md:text-xs font-black text-slate-900 dark:text-white pr-1">
            ...
            >
              <div className="flex items-center gap-3 md:gap-5">
                <div className="relative">
                  <div className="text-3xl md:text-6xl font-black text-transparent bg-clip-text bg-gradient-to-br from-amber-500 to-orange-600">
                    2+
                  </div>
                  {/* [OPTIMIZATION] animate-ping uses CSS animation (GPU-composited) */}
          ...
          >
            <div className="space-y-4">
              <h2 className="text-4xl md:text-6xl font-black text-slate-900 dark:text-white leading-tight">
                Engineering{" "}
                <span className="text-primary">Intelligence</span> into Modern
                Web.
              </h2>
            ...
            <div className="space-y-4 text-lg text-slate-600 dark:text-slate-300 leading-relaxed text-justify">
              <p>
                I am <b>Subir Das</b>, a passionate <b>Full-Stack Developer</b>{" "}
                with extensive experience in building robust and scalable web
                applications. Beyond core development, I also specialize in{" "}
                <b>AI Agent Engineering</b> and <b>n8n Workflow Automation</b>,
                designing intelligent agents and automation pipelines to
                optimize complex business processes.
              </p>
              <p>
                By combining deep expertise in{" "}
                <b>Full-Stack Development</b> with advanced AI and automation
                skills, I create solutions that are both powerful and
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {coreCompetencies.map((item, idx) => (
                <div
                  key={idx}
                  className="p-4 rounded-2xl bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 hover:shadow-lg transition-all group"
                >
