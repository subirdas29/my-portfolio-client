              ...
              <div>
                  ...
                  >
                    <h2 className="text-4xl md:text-5xl font-black tracking-tight text-gray-900 dark:text-white capitalize">
                      My{" "}
                      <span className="bg-gradient-to-r from-yellow-600 to-orange-600 dark:from-yellow-400 dark:to-amber-500 text-transparent bg-clip-text">
                        {activeTab}
                      </span>
                    </h2>
            ...
            <div className="relative z-20 border-l-2 border-amber-500/30 dark:border-white/10 ml-4 md:ml-8">
                ...
                >
                  {data.map((item, index) => (
                    <div
                      key={index}
                      className="relative pl-12 md:pl-16 group/item"
                    >
                      {/* Timeline Icon */}
