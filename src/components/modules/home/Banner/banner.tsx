...
export default function Banner() {
  ...
  // [OPTIMIZATION] Memoize particle positions to avoid recalculating on every render.
  // This reduces CPU work and prevents unnecessary re-renders of animated elements.
  ...
  return (
    <section className="relative flex items-center justify-center min-h-screen bg-gradient-to-br from-[#F9FAFB] via-[#fff8e1] to-[#faffdd] dark:from-[#0a0219] dark:via-[#120825] dark:to-[#1b0c2d] text-gray-900 dark:text-white overflow-hidden">
      {/* [OPTIMIZATION] Animated Background Elements - GPU-accelerated transforms only */}
      <div className="absolute inset-0 overflow-hidden">
        {/* Floating Particles - using transform/opacity only (composited) */}
        ...
        {/* [OPTIMIZATION] Glowing orbs use CSS blur + transform only (GPU-composited).
            No layout-triggering properties like width/height/margin changes. */}
        <motion.div
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
          ...
          >
            ...
            >
              ...
              <span className="bg-gradient-to-r from-yellow-500 via-amber-500 to-orange-500 dark:from-yellow-400 dark:via-yellow-500 dark:to-amber-500 text-transparent bg-clip-text">
                {displayedRole}
                {/* [OPTIMIZATION] Typewriter cursor uses opacity animation only (GPU-composited) */}
                <motion.span
          ...
          >
            <div className="relative flex items-center justify-center">
              ...
              {/* [OPTIMIZATION] Rotating ring uses CSS transform only (GPU-composited) */}
              <motion.div
                animate={{ rotate: 360 }}
                transition={{
                  repeat: Infinity,
              ...
              >
                {/* [OPTIMIZATION] Orbital dots use scale animation only (GPU-composited) */}
                <motion.div
              ...
              {/* [OPTIMIZATION] Dashed ring uses transform only */}
              <motion.div
                animate={{ rotate: -360 }}
                transition={{
                  repeat: Infinity,
              ...
              {/* [OPTIMIZATION] Profile image: priority=true for LCP, explicit sizes for responsive loading */}
              <motion.div
              ...
              {/* [OPTIMIZATION] Floating sparkle badge uses transform/opacity only */}
              <motion.div
                className={cn(
